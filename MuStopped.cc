...
//
//
/// \file exampleMuStopped.cc
/// \brief Main program of the MuStopped example
...
int main(int argc,char** argv)
{
 ...
 // Set mandatory initialization classes
  ...
  runManager->SetUserInitialization(new MuStoppedActionInitialization(detectorConstruction));
